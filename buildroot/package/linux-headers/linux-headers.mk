...
LINUX_HEADERS_CUSTOM_LOCAL_PATH = $(call qstrip,$(BR2_LINUX_KERNEL_CUSTOM_LOCAL_PATH))
...
LINUX_HEADERS_SOURCE = $(LINUX_HEADERS_CUSTOM_LOCAL_PATH)
LINUX_HEADERS_SITE = $(patsubst %/,%,$(dir $(LINUX_HEADERS_CUSTOM_LOCAL_PATH)))
...
ifeq ($(BR2_KERNEL_HEADERS_VERSION)$(BR2_KERNEL_HEADERS_CUSTOM_TARBALL)$(BR2_LINUX_KERNEL_CUSTOM_LOCAL)$(BR2_KERNEL_HEADERS_CUSTOM_GIT),y)
...
ifeq ($(BR2_KERNEL_HEADERS_VERSION)$(BR2_KERNEL_HEADERS_AS_KERNEL)$(BR2_LINUX_KERNEL_CUSTOM_LOCAL)$(BR2_KERNEL_HEADERS_CUSTOM_TARBALL)$(BR2_KERNEL_HEADERS_CUSTOM_GIT),y)
